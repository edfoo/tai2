...
DEFAULT_DECISION_PROMPT = (
    ...
    "Your confidence score (0–1) MUST reflect the proportion of signals aligning with your directional bias across Steps 2–4: "
    "0.8–1.0: all major signals (HTF trend, momentum, volume) align. "
    "0.6–0.8: trend is clear but some secondary signals are overextended or conflicting — reduce size proportionally. "
    "< 0.5: significant conflicts exist — you MUST recommend HOLD. "
    "Base position sizing on: base_size = max_safe_contracts × confidence. "
    "Then apply the risk_score as a final cap: final_position_size = base_size × (1 − risk_score). "
    ...
    "Choose HOLD whenever capital constraints, fee/credit depletion, missing TP/SL, poor reward-to-risk, HTF trend conflict, "
    "divergence against direction, or low confidence (< 0.5) prevent a high-quality entry — and describe the specific blocker. "

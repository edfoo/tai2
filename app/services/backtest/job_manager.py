...
class BacktestJobManager:
    ...
    def submit_run(self, req: Any) -> str:
        ...
        config = build_backtest_config(
            ...
            slippage_stress_multiplier=req.slippage_stress_multiplier,
            spread_estimator=req.spread_estimator,
            spread_window=req.spread_window,
            liquidity_impact_coefficient=req.liquidity_impact_coefficient,
            candle_range_slippage_fraction=req.candle_range_slippage_fraction,
            max_liquidity_slippage_bps=req.max_liquidity_slippage_bps,
            liquidation_fee_bps=req.liquidation_fee_bps,
    ...
    def submit_grid(self, req: Any) -> str:
        ...
        base_config = build_backtest_config(
            ...
            taker_fee_bps=base_req.taker_fee_bps,
            maker_fee_bps=base_req.maker_fee_bps,
            slippage_bps=base_req.slippage_bps,
            slippage_mode=base_req.slippage_mode,
            slippage_stress_multiplier=base_req.slippage_stress_multiplier,
            spread_estimator=base_req.spread_estimator,
            spread_window=base_req.spread_window,
            liquidity_impact_coefficient=base_req.liquidity_impact_coefficient,
            candle_range_slippage_fraction=base_req.candle_range_slippage_fraction,
            max_liquidity_slippage_bps=base_req.max_liquidity_slippage_bps,
            liquidation_fee_bps=base_req.liquidation_fee_bps,
            funding_rate_pct=base_req.funding_rate_pct,
